...
For a detailed step-by-step guide to get these installed on your raspberry pi, please refer to the xref:OS/OS.adoc[Complete OS Setup Guide]
...
Use docker-compose to get the containers up and running on your pi. For more detailed steps on how to accomplish this step please refer to xref:API/startAPI.adoc[Starting the AV API].
...
please refer to the xref:DB/DB.adoc[Complete Database Guide]
...
on how to test the API enpoints please refer to the xref:API/API.adoc[Complete API Testing Guide]
