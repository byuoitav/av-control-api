...
var getInputTest = []stateTest{
	{
		...
		resp: generatedActions{
			Actions: []action{
				{
					ID:  "ITB-1101-D1",
					Req: newRequest(http.MethodGet, "/ITB-1101-D1.av/GetAVInput"),
				},
				{
					ID:  "ITB-1101-SW1",
					Req: newRequest(http.MethodGet, "/ITB-1101-SW1.av/GetVideoInput"),
				},
				{
					ID:  "ITB-1101-SW1",
					Req: newRequest(http.MethodGet, "/ITB-1101-SW1.av/GetAudioInput"),
				},
			},
			ExpectedUpdates: 1,
		},
